...
def validate_network(nodes: List[PlanningNodeInput]) -> Dict[str, Any]:
    ...
    Each node needs id, precNode (predecessor ids), and nodeTime (duration).
...
def analyze_project_network(
    ...
    Set longest/shortest/enumerate_paths (enumeratePaths) to choose which results
    to include. Path duration is the sum of nodeTime along that path.
    """
